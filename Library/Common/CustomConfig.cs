...
namespace ApocForms.Common
{
    ...
    {
        public const string APP_DATA_CONNECT_SETTINGS_KEY    = "ApocFormsData";
        public const string APP_LOG_CONNECT_SETTINGS_KEY     = "ApocFormsLog";
        public const string EF_ENTITIES_CONNECT_SETTINGS_KEY = "ApocFormsEntities";
        ...
        private const string APP_CONFIG_NAME_KEY = "KEY_APP_HostConfigName";
        ...
        private const string APP_LOG_DISPLAY_ITEMS_KEY = "KEY_APP_LogDisplayItemsYn";
        public static bool LogDisplayItemsYn
        {
            get { return AppSettings[APP_LOG_DISPLAY_ITEMS_KEY].ToLower() == "true"; }
            set { AppSettings[APP_LOG_DISPLAY_ITEMS_KEY] = value ? "true" : "false"; }
        }
        ...
        private const string APP_ADMIN_USERID_KEY = "KEY_APP_AdminUserID";
        public static int AdminUserId
        {
            get { return Convert.ToInt32(AppSettings[APP_ADMIN_USERID_KEY]); }
            set { AppSettings[APP_ADMIN_USERID_KEY] = value.ToString(); }
        }
        ...
        /// <summary>
        /// url of local instance (for redirection)
        /// </summary>
        public static string DebugRunLocalUrl
        {
            get { return AppSettings[APP_DEBUG_RUN_LOCAL_URL_KEY]; }
            set { AppSettings[APP_DEBUG_RUN_LOCAL_URL_KEY] = value; }
        }
        private const string APP_DEBUG_RUN_LOCAL_URL_KEY = "KEY_APP_DebugRunLocalUrl";

        /// <summary>
        /// show full debug output on error page
        /// </summary>
        public static bool DebugShowErrorYn
        {
            get { return AppSettings[APP_DEBUG_SHOW_ERROR_KEY].ToLower() == "true"; }
            set { AppSettings[APP_DEBUG_SHOW_ERROR_KEY] = value ? "true" : "false"; }
        }
        private const string APP_DEBUG_SHOW_ERROR_KEY = "KEY_APP_DebugShowErrorYn";
        ...
        public static void Initialize (CommonConfig aConfig)
        {
            ...
            LogDisplayItemsYn = aConfig.DisplayErrors;

            AdminUserId = aConfig.AdminUserId;
            ...
            UpdateCtxConnectionSetting (EF_ENTITIES_CONNECT_SETTINGS_KEY, DbConnectionTxt);
            ...
            DebugRunLocalUrl = aConfig.DebugRunLocalUrl;
            DebugShowErrorYn = aConfig.DebugShowError;
        }
    ...
    public class CommonConfig
    {
        ...
        [DataMember]
        public string DebugRunLocalUrl { get; private set; }

        [DataMember]
        public bool DebugShowError { get; private set; }
